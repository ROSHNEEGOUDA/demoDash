...
function SignInForm() {
  ...
  const handleOnSubmit = async (e) => {
    ...
    try {
      ...
      if (data.userType === "admin" || data.userType == userType) {   // use && at the place of || 
        navigate("/homepage");
      } else {
        navigate("/Dashboard");
      }
  ...
  return (
    <div className="form-container sign-in-container">
      <form onSubmit={handleOnSubmit} className="flex flex-col items-center">
        ...
        {/* { if you connected the backend remove the link tag but if not then let their be the button tag } */}
        <Link to="/homepage">              
